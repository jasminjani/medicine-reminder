...
```
cd existing_repo
git remote add origin https://gitlab.taskgrids.com/jasmin.jani/medicine-reminder.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.taskgrids.com/jasmin.jani/medicine-reminder/-/settings/integrations)
